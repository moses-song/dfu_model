...
try:
    from dino_v3_backbone import register_dino_v3_backbone
...
def setup(args):
    ...
    if not hasattr(cfg.MODEL.DINO_V3, "MODEL_NAME"):
        cfg.MODEL.DINO_V3.MODEL_NAME = "vit_base_patch16_dinov3.lvd1689m"
...
def main(args):
    ...
    # Freeze backbone for head-only training (handle DDP wrapper).
    model = trainer.model
